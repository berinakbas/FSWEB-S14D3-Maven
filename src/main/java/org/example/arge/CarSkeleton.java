...
public class CarSkeleton {
    ...
    public void runEngine(CarSkeleton carSkeleton){
        if(carSkeleton instanceof ElectricCar){
            ...
            System.out.println("The car engine is starting with hybrid. Per liter: " + hybridCar.getAvgKmPerLiter() + " km/l, battery size: " + hybridCar.getBatterySize() + " kWh, cylinders: " + hybridCar.getCylinders());
        } else if (carSkeleton instanceof GasPoweredCar) {
            GasPoweredCar gasPoweredCar = (GasPoweredCar) carSkeleton;
            System.out.println("The car engine is starting with gas. Per liter: " + gasPoweredCar.getAverageKmPerLiter() + " km/l");
        } else {
